...
namespace TableLayoutPanelSample
{
    public partial class XButton : Button
    {
        ...
        private TableLayoutPanelSample.Theme thm = TableLayoutPanelSample.Theme.MSOffice2010_BLUE;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (thm == TableLayoutPanelSample.Theme.MSOffice2010_BLUE || thm == TableLayoutPanelSample.Theme.MSOffice2010_Green || thm == TableLayoutPanelSample.Theme.MSOffice2010_Yellow || thm == TableLayoutPanelSample.Theme.MSOffice2010_Publisher ||
                thm == TableLayoutPanelSample.Theme.MSOffice2010_RED || thm == TableLayoutPanelSample.Theme.MSOffice2010_WHITE || thm == TableLayoutPanelSample.Theme.MSOffice2010_Pink)
            {
        ...
        public TableLayoutPanelSample.Theme Theme
        {
            get
            {
                if (this.colorTable == Colortable.Office2010Green)
                {
                    return TableLayoutPanelSample.Theme.MSOffice2010_Green;
                }
                else if (this.colorTable == Colortable.Office2010Red)
                {
                    return TableLayoutPanelSample.Theme.MSOffice2010_RED;
                }
                else if (this.colorTable == Colortable.Office2010Pink)
                {
                    return TableLayoutPanelSample.Theme.MSOffice2010_Pink;
                }
                else if (this.colorTable == Colortable.Office2010Yellow)
                {
                    return TableLayoutPanelSample.Theme.MSOffice2010_Yellow;
                }
                else if (this.colorTable == Colortable.Office2010White)
                {
                    return TableLayoutPanelSample.Theme.MSOffice2010_WHITE;
                }
                else if (this.colorTable == Colortable.Office2010Publisher)
                {
                    return TableLayoutPanelSample.Theme.MSOffice2010_Publisher;
                }

                return TableLayoutPanelSample.Theme.MSOffice2010_BLUE;
            }
            ...
            set
            {
                ...
                if (thm == TableLayoutPanelSample.Theme.MSOffice2010_Green)
                {
                    this.colorTable = Colortable.Office2010Green;
                }
                else if (thm == TableLayoutPanelSample.Theme.MSOffice2010_RED)
                {
                    this.colorTable = Colortable.Office2010Red;
                }
                else if (thm == TableLayoutPanelSample.Theme.MSOffice2010_Pink)
                {
                    this.colorTable = Colortable.Office2010Pink;
                }
                else if (thm == TableLayoutPanelSample.Theme.MSOffice2010_WHITE)
                {
                    this.colorTable = Colortable.Office2010White;
                }
                else if (thm == TableLayoutPanelSample.Theme.MSOffice2010_Yellow)
                {
                    this.colorTable = Colortable.Office2010Yellow;
                }
                else if (thm == TableLayoutPanelSample.Theme.MSOffice2010_Publisher)
                {
